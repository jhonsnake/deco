...
const getUserDisplayName = (userId: string | null, isAnonymous: boolean): string => {
...
export const mockReports: MockReport[] = [
  {
    ...
    description: 'Hay un bache muy grande en la Calle Luna, cerca de la esquina con Sol. Ya varios autos han tenido problemas. Necesita reparación urgente.',
    categoryID: mockCategories[0].id, // Problemas de Infraestructura
    location: {
      latitude: 19.4326, // Mexico City coordinates (example)
      longitude: -99.1332,
      addressText: 'Calle Luna esq. Sol, Colonia Centro, Ciudad Ejemplo',
    },
    cloudinaryMedia: [
      { public_id: 'sample1', url: 'https://via.placeholder.com/300x200.png?text=Bache+Foto+1', type: 'image' },
      { public_id: 'sample2', url: 'https://via.placeholder.com/300x200.png?text=Bache+Foto+2', type: 'image' },
    ],
    isAnonymous: false,
  ...
  },
  {
    ...
    description: 'El contenedor de basura en el parque Los Alamos lleva más de una semana sin recogerse. Atrae plagas y mal olor.',
    categoryID: mockCategories[1].id, // Servicios Públicos Deficientes
    location: {
      latitude: 19.4285,
      longitude: -99.1276,
      addressText: 'Parque Los Alamos, Colonia Robles, Ciudad Ejemplo',
    },
    cloudinaryMedia: [
      { public_id: 'sample3', url: 'https://via.placeholder.com/300x200.png?text=Basura+Foto', type: 'image' },
    ],
    isAnonymous: true,
    creatorUserID: null,
  ...
  },
  {
    ...
    description: 'El lote baldío en la Av. Principal podría convertirse en un hermoso jardín comunitario. Propongo que nos organicemos para limpiarlo y sembrar.',
    categoryID: mockCategories[4].id, // Propuesta Social
    location: {
      latitude: 19.4350,
      longitude: -99.1300,
      addressText: 'Av. Principal #123, Colonia Esperanza, Ciudad Ejemplo',
    },
    isAnonymous: false,
  ...
  },
  {
    ...
    description: 'Todo el Pasaje Estrellita está a oscuras por la noche, lo que lo hace inseguro. Se necesitan nuevas luminarias o reparar las existentes.',
    categoryID: mockCategories[0].id, // Problemas de Infraestructura
    location: {
      latitude: 19.4200,
      longitude: -99.1400,
      addressText: 'Pasaje Estrellita, Colonia Vista Hermosa, Ciudad Ejemplo',
    },
    cloudinaryMedia: [],
    isAnonymous: false,
  ...
  },
  {
    ...
    description: 'Fui testigo de una situación que parecía un soborno a un inspector en las oficinas municipales de tránsito el día de ayer. Prefiero no dar más detalles públicamente por seguridad.',
    categoryID: mockCategories[5].id, // Actos de Corrupción
    location: {
      latitude: 19.4320,
      longitude: -99.1350,
      addressText: 'Oficinas Municipales de Tránsito, Ciudad Ejemplo',
    },
    isAnonymous: true,
    creatorUserID: null,
    creatorDisplayName: getUserDisplayName(null, true),
